  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="hero">
          <div className="container grid2">
            <div>
              ...
              <p className="lead">
                ‘라파(Rapha)’는 히브리어로 ‘치유’. 55가지 순수 스트레칭으로
                유연성과 균형을 회복하도록 돕습니다.
              </p>
              <div className="cta">
            ...
            <div className="photo">
              <div className="ph">사진 준비중</div>
              {/* 사진 생기면 아래 줄로 교체:
              <img src="/images/rapha-center-1.jpg" alt="센터 내부" />
              */}
            </div>
          </div>
        </section>
        ...
        <section id="program" className="section">
          <div className="container cards3">
            <div className="card">
              <h3>55가지 순수 스트레칭</h3>
              <p>명상·음악 없이 몸의 균형과 유연성에 집중합니다.</p>
            </div>
            <div className="card">
              <h3>통증 완화 & 수면 개선</h3>
              <p>꾸준히 참여하신 분들이 경험한 대표적인 변화입니다.</p>
            </div>
            <div className="card">
              <h3>센터빌 10+년</h3>
              <p>지역 한인 커뮤니티와 함께한 믿을 수 있는 운영.</p>
            </div>
          </div>
        </section>
            ...
            <div className="grid2 gap">
              <div className="card">
                ...
                <div className="badges">
                  <span className="badge">09:10 - 10:10</span>
                  <span className="badge">10:30 - 11:30</span>
                </div>
              </div>
              <div className="card">
                <h4>월, 목 (PM)</h4>
                <div className="badges">
                  <span className="badge">18:00 - 19:00</span>
                  <span className="badge">20:00 - 21:00</span>
                </div>
              </div>
            </div>
            <p className="small mt8">
              처음 오시는 분도 부담 없이 참여하실 수 있습니다. 다만 라파스트레칭은 일정 강도의 전신운동이 포함되어 있어
              신규 등록은 <b>70세 이하</b>까지만 받고 있습니다. 안전과 적응을 위한 조치이오니 양해 부탁드립니다. 🙏
            </p>
          </div>
        </section>
        ...
        <section id="pricing" className="section">
          <div className="container">
            ...
            <div className="card">
              ...
              <p className="small">근육은 72시간 후 원상복귀되므로 최소 주 2회 이상을 권장합니다.</p>
              <ul className="list">
                <li>그룹 클래스</li>
                <li>개별 자세 코칭</li>
                <li>매트 제공</li>
          ...
          <div className="container grid2">
            <div className="card">
              ...
              <ul className="list">
                ...
                <li>📷 인스타그램: <a href="#" target="_blank" rel="noreferrer">@rapha.stretching</a></li>
                <li>📍 14641 Route 29 Suite 107, Centreville VA 20121</li>
              </ul>
              <a className="btn" href="tel:+17033501576">지금 전화하기</a>
              <p className="disclaimer">※ 라파스트레칭은 의학적 진단·치료를 대체하지 않습니다. 통증/질환이 있는 경우 전문의와 상의하세요.</p>
            </div>
            <div className="map card">
              <iframe
                title="Rapha Stretching Location"
      ...
      <footer className="footer">
        <div className="container">
          © {new Date().getFullYear()} RaphaStretching |
          14641 Route 29 Suite 107, Centreville VA 20121 | ☎ 703-350-1576
        </div>
      </footer>
      ...
      <style jsx>{`
        ...
        *{box-sizing:border-box}
        body{margin:0;color:#0a0a0a;background:linear-gradient(#fff,#fafafa)}
        ...
        .nav{display:flex;gap:14px;align-items:center}.nav a{text-decoration:none;color:#111;font-size:14px}
        ...
        .lead{color:#6b7280;margin-top:8px;line-height:1.6}
        ...
        h1{margin:0 0 8px 0;font-size:36px;line-height:1.2}
        h2{margin:0 0 14px 0;font-size:28px}
        .badges{display:flex;gap:8px;flex-wrap:wrap}
        .badge{font-size:12px;border:1px solid var(--line);background:#f3f4f6;border-radius:999px;padding:6px 10px}
